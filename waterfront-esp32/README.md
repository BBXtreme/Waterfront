...
## Overview
The WATERFRONT system is an ESP32-based controller for automated kayak rental bays. It manages compartment gates, deposit logic, sensor monitoring, and remote connectivity via MQTT with TLS support. The system includes power management, OTA updates, and provisioning features for reliable, low-power operation in outdoor environments.

## Features
- **Secure MQTT Communication**: TLS with CA and optional client certificates
- **Power Management**: Deep sleep, solar/battery monitoring, LTE power gating
- **OTA Updates**: Over-the-air firmware updates with progress monitoring
